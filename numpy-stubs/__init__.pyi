...
class ndarray(Generic[_DType]):
    ...
    @overload
    def __getitem__(self, key: Union[int, Tuple[int, ...]]) -> Union[ndarray[_DType], _DType]: ...
    @overload
    def __getitem__(
        self,
        key: Union[
    ...
    def __lt__(self, value: object) -> ndarray[bool_]: ...
...
def load(file: Union[str, Path, IO], encoding: str = ...) ->  ndarray: ...
def loadtxt(
    fname: Any,
    dtype: Type[_DType] = ...,
...
@overload
def cos(a: _FloatObj) -> _FloatObj: ...
@overload
def cos(a: ndarray[_DType]) -> ndarray[_DType]: ...  
...
def save(
    file: Union[str, BinaryIO, Path], arr: ndarray, allow_pickle: bool = ..., fix_imports: bool = ...
) -> None: ...
@overload
...
@overload
def sin(a: _FloatObj) -> _FloatObj: ...
@overload
def sin(a: ndarray[_DType]) -> ndarray[_DType]: ... 
